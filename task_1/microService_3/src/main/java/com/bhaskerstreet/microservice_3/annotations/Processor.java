package com.bhaskerstreet.microservice_3.annotations;
...
public class Processor {
    ...
    private static final Logger LOGGER = LogManager.getLogger(com.bhaskerstreet.microservice_3.annotations.LogMethodParam.class);
