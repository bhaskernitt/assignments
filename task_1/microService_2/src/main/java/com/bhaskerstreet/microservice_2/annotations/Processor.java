package com.bhaskerstreet.microservice_2.annotations;
...
public class Processor {
    ...
    private static final Logger LOGGER = LogManager.getLogger(com.bhaskerstreet.microservice_2.annotations.LogMethodParam.class);
